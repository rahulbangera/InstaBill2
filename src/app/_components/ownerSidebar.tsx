...
const OwnerSidebar = () => {
  ...
  return (
    ...
    } flex-shrink-0 bg-gray-800 transition-all duration-300 ease-in-out z-[9999]`}
  >
    <button
      onClick={() => setCollapsed(!collapsed)}
      className="absolute right-0 top-1/2 flex h-8 w-8 items-center justify-center bg-gray-900 hover:bg-gray-800 shadow-lg"
    >
      {collapsed ? (
    ...
    <div className="h-4/5">
      ...
      <Link
        className={`flex w-full justify-center border-b-2 border-gray-500 p-4 ${
          pathname === "/dashboard/owner" ? "bg-gray-900" : "hover:bg-gray-700"
        } text-gray-300`}
    ...
    {profileModal && (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
        <div className="w-1/3 rounded-lg bg-gray-800 p-5">
          <h2 className="mb-4 text-xl text-gray-200">Update Profile Picture</h2>
